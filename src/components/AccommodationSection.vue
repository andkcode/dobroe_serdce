...
const options: AccommodationOption[] = [
  {
    icon: `<svg viewBox="0 0 32 32" xmlns="https://www.w3.org/2000/svg" width="58" height="58">
  ...
  {
    icon: `<svg viewBox="0 0 32 32" xmlns="https://www.w3.org/2000/svg" width="64" height="64">
...
const optionsView = computed(() => {
  const optionTexts = tm('accommodation.options') as Array<{
    title: string
    subtitle: string
    description: string
  }>
      ...
      <div class="grid gap-8 grid-cols-1 lg:grid-cols-2" data-animate>
        ...
        >
          <div class="mb-6 flex items-center gap-3">
            ...
            <div>
              <h3 class="font-display text-2xl font-600 text-ink-900">{{ t('accommodation.acceptedTitle') }}</h3>
        ...
        >
          <div class="mb-6 flex items-center gap-3">
            ...
            <div>
              <h3 class="font-display text-2xl font-600 text-ink-900">{{ t('accommodation.blockedTitle') }}</h3>
