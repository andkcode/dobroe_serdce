    ...
    <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
      ...
      >
          ...
          <div class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-start sm:gap-4">
            ...
            <div>
              <div class="mb-1 flex flex-wrap items-center gap-2">
                <h3 class="font-display text-xl font-600 text-ink-900">{{ t('services.ctaTitle') }}</h3>
                <span
        ...
        <div class="relative z-10 mt-5 flex flex-wrap gap-2">
          <span class="rounded-full border px-3 py-1 text-xs font-500" style="border-color: var(--color-sapphire-200); background: var(--color-sapphire-100); color: var(--color-sapphire-800);">{{ t('services.chip1') }}</span>
          <span class="rounded-full border px-3 py-1 text-xs font-500" style="border-color: var(--color-sapphire-200); background: var(--color-sapphire-100); color: var(--color-sapphire-800);">{{ t('services.chip2') }}</span>
        </div>
      </div>
    </div>
  </section>
